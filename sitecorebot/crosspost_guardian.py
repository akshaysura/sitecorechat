...
def crosspost_guardian(app, message, say):
    ...
    if user_id in user_message_memory:
        ...
        for m in message_list:
            ...
            if fuzzy_ratio > 90:
                ...
                print(f"fuzz.ratio for message: {fuzzy_ratio}")
        ...
        if not suspected_duplicate is None:
            ...
            message_text = f"Message {message_permalink['permalink']} is a suspected duplicate of {duplicate_suspect_permalink['permalink']}. Confidence: {highest_fuzzy_score}"
